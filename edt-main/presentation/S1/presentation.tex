...
\usepackage[french]{babel} %% installer texlive-lang-french pour cela
...
\xdefinecolor{tsinghua}{RGB}{248,142,85}  %RGB#82318E
...
\AtBeginSubsection[]{\begin{frame}\tableofcontents[sectionstyle=show/shaded,subsectionstyle=show/shaded/hide,subsubsectionstyle=show/shaded/hide]\end{frame}}
